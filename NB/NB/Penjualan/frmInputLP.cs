...
namespace NB
{
    public partial class frmInputLP : Telerik.WinControls.UI.RadForm
    {
        private DataRow row_;
        private string tipe_;
        public frmInputLP(string Tipe)
        {
            InitializeComponent();
            this.Text = "Input " + Tipe;
            tipe_ = Tipe;

            dtpKembali.Value = DateTime.Now;
            dtpTanggal.Value = DateTime.Now;
        }
        public frmInputLP():this("Penjualan")
        {
        ...
        private void btnMulai_Click(object sender, EventArgs e)
        {
            ...
            { 
                case "UJ":
                    //Check if surat jalan contains UJ
                    break;
            }
            GetSJDetail();
        }
