...
namespace NB
{
    public partial class frmInputSJCampuran : RadForm
    {
        ...
        public frmInputSJCampuran():this("Campuran",true)
        {
            
        }
        public frmInputSJCampuran(string sValue, bool bIsNew)
        {
            InitializeComponent();
            isEdit_ = (!bIsNew);
            custType_ = sValue;
        ...
        private void chkAntar_ToggleStateChanged(object sender, StateChangedEventArgs args)
        {
            ...
            rddKernet.Enabled = diAntar_;
            rddMobil.Enabled = diAntar_;
            rddSopir.Enabled = diAntar_;
        }
